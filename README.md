...
Answer: The semantic is the element that have meaning for HTML that can descrip the element we use to code for HTML.

2. What are the 4 areas of the box model?
Asnwer: Margin, Border, Padding, and Content.

3. While using flexbox, what axis does the following property work on: ```align-items: center```? 
Answer: Cross asix.

4. Explain why git is valuable to a team of developers.
Answer: Git is The concept of version control and source control an distribute that help to get in the terminal to work to our file and without open the new file, and for the team developer to work as a team or independent. without .  

5. Define mobile-first design in your own words.
Answer: Define mobile-first is the responsive for the website that get result on the mobile-first when we code. 
